...
ACCEPTANCE_SCRIPTS := scripts/e2e-test.sh scripts/fault-injection-test.sh scripts/torture-test.sh scripts/run-e2e-isolated.sh scripts/run-benchmark-isolated.sh scripts/run-fault-injection-isolated.sh scripts/webdav-client-smoke.sh scripts/with-test-dataplane.sh
