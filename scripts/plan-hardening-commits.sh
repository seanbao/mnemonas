...
classify_file() {
	...
	case "$file" in
		...
		Dockerfile|.dockerignore|docker-compose.yml|docker-compose.yaml|mnemonas.example.toml|deploy/public-access/*|scripts/install-systemd.sh|scripts/uninstall-systemd.sh|scripts/mnemonas-doctor.sh|scripts/mnemonas-docker-preflight.sh|scripts/docker-quickstart.sh|scripts/docker-smoke.sh|scripts/docker-start.sh|scripts/setup-reverse-proxy.sh|scripts/public-go-live-smoke.sh|scripts/mnemonas-dataplane-start.sh|scripts/verify-release-artifacts.sh|scripts/verify-published-release.sh|scripts/release-go-live-check.sh|scripts/release-readiness.sh|scripts/dev.sh|scripts/benchmark.sh|scripts/test-systemd-*.sh|scripts/test-docker-*.sh|scripts/test-dataplane-start.sh|scripts/test-dev-safety.sh|scripts/test-reverse-proxy-safety.sh|scripts/test-public-access-templates.sh|scripts/test-public-go-live-smoke.sh|scripts/test-release-package.sh|scripts/test-release-artifacts.sh|scripts/test-published-release.sh|scripts/test-release-go-live-check.sh|scripts/test-release-readiness.sh|scripts/test-benchmark-safety.sh)
			...
			return 0
			;;
		.github/dependabot.yml|.github/dependabot.yaml|.github/workflows/*|Makefile|scripts/check-*.sh|scripts/test-*.sh|scripts/verify-changed.sh|scripts/plan-hardening-commits.sh|scripts/e2e-test.sh|scripts/fault-injection-test.sh|scripts/torture-test.sh|scripts/run-*.sh|scripts/webdav-client-smoke.sh|scripts/with-test-dataplane.sh|web/scripts/*|web/.husky/*)
...
print_check_block() {
	...
	case "$group" in
		...
		build-ci)
			...
			;;
		feat-api)
			printf 'GOTOOLCHAIN=local CGO_ENABLED=1 bash ./scripts/with-test-dataplane.sh go test -timeout=30m -p=3 -race ./internal/api ./internal/share ./internal/webdav\n'
			print_group_diff_check "$group"
			;;
		feat-core)
			printf 'GOTOOLCHAIN=local CGO_ENABLED=1 bash ./scripts/with-test-dataplane.sh go test -timeout=30m -p=3 -race ./cmd/healthcheck ./cmd/nasd ./internal/activity ./internal/alerts ./internal/auth ./internal/backup ./internal/caslayout ./internal/config ./internal/diskhealth ./internal/favorites ./internal/smbcred ./internal/smbgateway ./internal/storage ./internal/thumbnail ./internal/versionstore ./internal/workspace\n'
