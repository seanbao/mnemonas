...
touch README.md CONTRIBUTING.md CONTRIBUTING.en.md .github/pull_request_template.md .github/ISSUE_TEMPLATE/bug_report.yml Makefile Dockerfile go.mod dataplane/src/lib.rs tools/proto-gen/Cargo.toml
...
assert_file_contains "$output_dir/plan.out" "[hardening-commit-plan] grouped 18 changed file(s)"
...
assert_file_contains "$output_dir/no-manual.out" "[hardening-commit-plan] grouped 17 changed file(s)"
