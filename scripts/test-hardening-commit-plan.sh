...
assert_file_contains "$output_dir/plan.out" "[hardening-commit-plan] grouped 25 changed file(s)"
...
assert_file_contains "$output_dir/no-manual.out" "[hardening-commit-plan] grouped 24 changed file(s)"
