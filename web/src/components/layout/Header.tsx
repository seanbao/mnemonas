  ...
  return (
    <header className="h-[60px] bg-bg-primary/80 backdrop-blur-md border-b border-divider flex items-center justify-between px-7 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-2.5 px-3.5 py-2 bg-bg-card border border-divider rounded-[10px] w-[260px] focus-within:border-accent-primary focus-within:ring-1 focus-within:ring-accent-primary/20 transition-all duration-200">
          ...
          >
            <DropdownItem key="profile" className="h-14 gap-2" textValue="Profile">
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <p className="font-semibold text-text-primary">管理员</p>
                  <p className="text-xs text-text-muted">admin@local</p>
                </div>
              </div>
            </DropdownItem>
