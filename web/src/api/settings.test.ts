...
describe('Settings API', () => {
  ...
  it.each([
    ...
    ['versioning max size above object limit', { versioning: { auto_versioned_extensions: ['.txt'], auto_versioned_filenames: [], max_versioned_size: 104857601 } }],
  ...
  it.each([
    ...
    ['versioning max size above object limit', { versioning: { max_versioned_size: 104857601 } }, 'INVALID_VERSIONING_MAX_VERSIONED_SIZE'],
