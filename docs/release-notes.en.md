...
- Documentation checks require the bilingual release-notes pre-release validation list to keep its Playwright E2E and frontend-unit-test counts aligned with the latest full-validation evidence in the hardening review summary, preventing stale local counts after validation evidence refreshes.
