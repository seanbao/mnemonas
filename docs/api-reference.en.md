...
Return persisted activity review disposition records. The Trash restore page writes matching `trash_restore` activity entries into `restored` disposition records; share-review records may include `share_disposition_details` with redacted share-disposition clues.
