...
| Share safety | Share links exist | Add default expiry, download limits, share risk hints, and one-click disable actions | Admins can inspect, search, and disable all shares, and can find long-lived public links or links that cover too much content |
