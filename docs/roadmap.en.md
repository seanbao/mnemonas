...
| Capability | Gap | Suggested implementation | Acceptance criteria |
| --- | --- | --- | --- |
| Folder-level permissions | Basic directory ACLs and groups exist; inheritance, policy presets, and clearer admin reporting are still missing | Add inheritance/policy previews, share-permission impact checks, and audit reports | Web, API, WebDAV, and shares use the same permission decision, and admins can review effective access |
