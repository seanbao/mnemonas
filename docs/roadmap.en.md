...
- Batch entry point: batch restore attention reasons, suggested next steps, progress steps, selection, preview, pre-submit review, execution, and copyable batch-restore records.
