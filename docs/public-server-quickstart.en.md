...
- [ ] If public sharing is enabled, `share.default_expires_in` is not empty or `0`, is at most `720h`, `share.default_max_access` is greater than `0`, and the `mnemonas-doctor --public-domain` public-share JSON response boundary check passes.
